...
s.test_sens = 1; s.test_frac = 1; s.test_days = "2x_week"; s.test_type = "staff"; s.test_start_day = 1
...
make_df = function(disperse = T, # how to distribute runs
  ...
  df = df %>%
    ...
    filter((test_days=="2x_week" & test_sens == 1 & test_frac == 1 & test_type == "staff") | test)
