    ...
    if(test){
      ...
      if(!test_recovered){
        ...
        if(t%in%testing_days){
          ...
          # testing ONLY staff
          df_time_novisit = df_time_test[(df_time_test$type==1 | df_time_test$type==3),]
          ...
          df_time_test[(df_time_test$type==1 | df_time_test$type==3),] = df_time_novisit
        }
        ...
        if(t%in%testing_days){
          ...
          # testing ONLY staff
          df_time_novisit = df_time[(df_time$type==1 | df_time$type==3),]
          ...
          df_time[(df_time$type==1 | df_time$type==3),] = df_time_novisit
        }
