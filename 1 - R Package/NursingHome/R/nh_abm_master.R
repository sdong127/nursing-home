...
#'
#' @param synthpop synthetic population; load synthpop.csv file
#' @param cohorting assign staff to residents; defaults to T (note to self that setting this to F does not change level of viral spread)
...
#' @param p_asymp_nonres Fraction of non-residents with asymptomatic disease; defaults to 0.5
#' @param p_asymp_res Fraction of residents with asymptomatic disease; defaults to 0.5
...
#' @param res_boost Proportion of residents with booster dose
#' @param staff_vax_req Whether staff are required to get most updated recommended vaccine; defaults to F
#' @param staff_boost Proportion of staff with booster dose
#' @param visit_boost Proportion of visitors with booster dose
#' @param staff_trans_red Factor by which staff transmissibility is reduced due to intervention; defaults to 0.7
#' (used to be teacher_trans)
#' @param visit_trans_red Factor by which visitor transmissibility is reduced due to intervention; defaults to 0
#' (used to be family_susp)
#' @param res_trans_red Factor by which resident transmissibility is reduced due to intervention; defaults to 0
#' @param staff_susp_red Factor by which staff susceptibility is reduced due to intervention; defaults to 0
#' (used to be teacher_trans)
#' @param visit_susp_red Factor by which visitor susceptibility is reduced due to intervention; defaults to 0
#' (used to be family_susp)
#' @param res_susp_red Factor by which resident susceptibility is reduced due to intervention; defaults to 0
#' @param isolate Whether symptomatic individuals isolate when symptoms emerge; defaults to T
#' @param prim_previnf_eff efficacy of 2 doses or previous infection; defaults to 0.4
#' @param boost_eff booster efficacy; defaults to 0.7
...
#' @param start dataframe from make_NH()
#'
#' @return df dataframe of resident and staff attributes
#'
#' @export
initialize_NH = function(p_asymp_nonres = 0.5, p_asymp_res = 0.5, p_subclin_nonres = 0, p_subclin_res = 0,
                         daily_attack = .18, staff_vax_req = F, 
                         res_boost = 0.74, staff_boost = 0.51, visit_boost = 0.34, 
                         staff_trans_red = 0.7, visit_trans_red = 0, res_trans_red = 0, 
...
#' @param nh dataframe from initialize_NH()
#'
...
#'
#' @return id's of infected individuals
#'
#' @export
...
#'
#' Determine who is infected at a timestep from contact between in-nursing-home staff
#'
...
#'
#' @param df.u dataframe in run_model() of infected individuals
#' @param time number of days to run model; defaults to 30
...
#'
#' @export
make_infected_start = function(df.u, time = 30, days_inf = 5, days_isolate_res = 10, days_isolate_staff = 7,
...
#'
#' @export
make_infected = function(df.u, days_inf = 5, days_isolate_res = 10, days_isolate_staff = 7,
                         days_isolate_visit = 5, set = NA, seed_asymp = F){
...
#' @param test whether there is screening
...
#' @param test_start_day day tests are implemented for weekly testing
...
#' @param n_contact_staff number of contacts a staff member has with other staff members during a shift; defaults to 6
#' @param days_inf length of infectious period, defaults to 5 days
#' @param days_isolate_res length of isolation for residents, defaults to 10
#' @param days_isolate_staff length of isolation for staff, defaults to 7
#' @param days_isolate_visit length of isolation for visitors, defaults to 5
#' @param seed_asymp whether to seed with an asymptomatic case
#' @param staff_prob set daily probability of infectious entry for staff (based on COVID-19 community incidence)
#' @param visit_prob set daily probability of infectious entry for visitors (based on COVID-19 community incidence)
#' @param rel_trans_common relative transmission in common area interactions vs. resident's room; defaults to 1/4
#' @param rel_trans_staff relative transmission in staff-staff interactions vs. resident's room; defaults to 1/4
...
#' @param test_recovered whether or not to test recovered individuals; defaults to T
#' @param df data frame from make_schedule()
...
#' @param staff_boost Proportion of staff with booster dose
#' @param visit_boost Proportion of visitors with booster dose
#' @param staff_trans_red Factor by which staff transmission is reduced due to intervention; defaults to 0.7
#' @param visit_trans_red Factor by which visitor transmission is reduced due to intervention; defaults to 0
#' @param res_trans_red Factor by which resident transmission is reduced due to intervention; defaults to 0
#' @param staff_susp_red Factor by which staff susceptibility is reduced due to intervention; defaults to 0
#' @param visit_susp_red Factor by which visitor susceptibility is reduced due to intervention; defaults to 0
#' @param res_susp_red Factor by which resident susceptibility is reduced due to intervention; defaults to 0
...
#' @param n_contact_staff number of contacts a staff member has with other staff members; defaults to 6
#' @param days_inf length of infectious period, defaults to 5
#' @param days_isolate_res length of isolation for residents, defaults to 10
#' @param days_isolate_staff length of isolation for staff, defaults to 7
#' @param days_isolate_visit length of isolation for visitors, defaults to 5
...
#' @param test_days test frequency; "day", "week", "2x_week"
#' @param test_type group tested; defaults to "all", also allows "staff" and "residents"
#' @param test_start_day day tests are implemented for weekly testing
#' @param visit_test whether visitors test before entering NH
#' @param staff_prob set daily probability of infectious entry for staff, based on community incidence
#' @param visit_prob set daily probability of infectious entry for visitors, based on community incidence
#' @param quarantine whether people quarantine upon exposure; defaults to F
...
mult_runs = function(N, rel_trans_common = 1/4, rel_trans_staff = 1/4, 
                     ...
                     n_contact_staff = 6, days_inf = 5, days_isolate_res = 10,
                     ...
                     test_type = 'all', test_start_day = 7, visit_test = F, staff_prob = 0.005, visit_prob = 0.005,
  ...
  for(i in 1:N){
    ...
    df = run_model(time = time, test = test, test_days = test_days, test_sens = test_sens, 
                   ...
                   days_inf = days_inf, days_isolate_res = days_isolate_res, days_isolate_staff = days_isolate_staff, days_isolate_visit = days_isolate_visit,
                   seed_asymp = seed_asymp, staff_prob = staff_prob, visit_prob = visit_prob, quarantine = quarantine, quarantine.length = quarantine.length,
